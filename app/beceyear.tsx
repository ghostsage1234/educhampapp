        ...
        <ScrollView style={{ width: '100%' }} showsVerticalScrollIndicator={false}>
          {YEARS.map((year) => (
            <View key={year} style={styles.yearSection}>
              <Text style={[styles.yearTitle, { color: subjectColor as string || '#ffd700' }]}>
                📋 BECE {year}
              </Text>
              <TouchableOpacity
                ...
                onPress={() => router.push({
                  pathname: '/beceview',
                  params: { className, subject, year, subjectColor, type: 'objectives' }
                })}
                activeOpacity={0.8}
              >
                ...
                <View>
                  ...
                  <Text style={styles.typeSub}>40 questions • View questions and answers</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                onPress={() => router.push({
                  pathname: '/beceview',
                  params: { className, subject, year, subjectColor, type: 'essays' }
                })}
                activeOpacity={0.8}
              >
                <Text style={styles.typeEmoji}>📝</Text>
                <View>
                  ...
                  <Text style={styles.typeSub}>Answer in your book</Text>
                </View>
              </TouchableOpacity>
            </View>
          ))}
